...
function Contacts() {
    ...
    const useStyles = makeStyles((t) => ({
        input: {
            border: `4px solid ${theme.darkbrowny}`,
    ...
    return (
        ...
        >
            <div className='contacts--container'>
                <h1 style={{ color: theme.darkbrowny }}>Contacts</h1>
