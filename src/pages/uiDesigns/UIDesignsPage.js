...
const UIDesignsPage = () => {
    ...
    const filteredArticles = UiData.filter((project) => {
    ...
    return (
        <div className="projectPage" style={{backgroundColor: theme.tertiary}}>
            <Helmet>
                <title>{headerData.name} | UI Designs</title>
            </Helmet>
            <div className="projectPage-header" style={{backgroundColor:theme.browny}}>
                <Link to="/">
                        <AiOutlineHome className={classes.home}/>
                </Link>
                <h1 style={{color: theme.secondary}}>UI Designs</h1>
            </div>
